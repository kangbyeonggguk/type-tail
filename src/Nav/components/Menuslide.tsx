  ...
  return (
    <div className="w-[830px] overflow-hidden ">
      ...
      >
        ...
        <span className="text-[12px] text-[#333] pr-[8px] content-center">
          쿠팡플레이
        </span>
        ...
        <span className="ml-[10px] pl-[5px] text-[12px] text-[#333] pr-[5px] content-center">
          골드박스
        </span>
        <span className="ml-[10px] pl-[5px] text-[12px] text-[#333] pr-[5px] content-center">
          와우할인할인
        </span>
        <span className="ml-[10px] pl-[5px] text-[12px] text-[#333] pr-[6px] content-center">
          이벤트/쿠폰
        </span>
        <div className="h-[32px] content-center">
          <img
